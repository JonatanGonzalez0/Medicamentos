...
public class FormRegistroPaciente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Formulario Registro Paciente ");
        ...
        JbuttonRegistrarPaciente.setBackground(java.awt.SystemColor.textHighlight);
        JbuttonRegistrarPaciente.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        jPanel1.add(JbuttonRegistrarPaciente, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 480, -1, 51));
    ...
    private void JbuttonRegistrarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JbuttonRegistrarPacienteActionPerformed
        ...
        if (!nombre.equals("") && !apellido.equals("")) {
            ...
            try {
                ...
                PreparedStatement preparedStatement = connection.prepareStatement("SELECT COUNT(*) FROM PACIENTES WHERE nombre = ?");
                ...
                if (resultSet.next() && resultSet.getInt(1) == 0) {
                    ...
                    PreparedStatement insertStatement = connection.prepareStatement("INSERT INTO PACIENTES (nombre) VALUES (?)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRegistroPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FormRegistroPaciente().setVisible(true);
        });
    }
